...
router.get("/dashboard", withAuth, async (req, res) => {
  try {
    ...
    if (search) {
      whereOptions = { ...whereOptions, project_name: { [Op.substring]: search } }
    }
    ...
    if (searchTags) {
      ...
      projects = projects.filter((value, index, self) =>
    ...
    if (searchSort) {
      switch (searchSort) {
        case "sort-project-name":
          projects = projects.sort(function (a, b) { return (a.project_name > b.project_name) ? 1 : ((b.project_name > a.project_name) ? -1 : 0) });
          break;
        case "sort-project-due":
          projects = projects.sort((a, b) => a.project_due - b.project_due);
          break;
        case "sort-project-status":
          projects = projects.sort(function (a, b) { return (a.project_status > b.project_status) ? 1 : ((b.project_status > a.project_status) ? -1 : 0) });
          break;
      }
    }
